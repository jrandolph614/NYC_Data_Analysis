...
with open("Zip_MedianRentalPrice_AllHomes.csv", encoding="iso-8859-1") as csv_file:
...
with open("MarketHealthIndex_Zip.csv", encoding="iso-8859-1") as csv_file:
    csv_reader = csv.reader(csv_file, delimiter=',')
    next(csv_reader)
    for row in csv_reader:
        zipcode = row[1]
...
with open("IRSIncomeByZipCode.csv", encoding="iso-8859-1") as csv_file:
    csv_reader = csv.reader(csv_file, delimiter=',')
    next(csv_reader)
    for row in csv_reader:
        if row[0] == 'NY':
...
with open("Ny_Data.csv", encoding="iso-8859-1") as csv_file:
    csv_reader = csv.reader(csv_file, delimiter=',')
    next(csv_reader)
    for row in csv_reader:
        zipcode = row[1]
